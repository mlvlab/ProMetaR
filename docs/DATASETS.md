...
### Acknowledgement: This readme file for installing datasets has been borrowed directly from [PromptSRC's](https://github.com/muzairkhattak/PromptSRC) official repository.
